...
ggplot(aes(x = Cooking)) +
  geom_histogram(binwidth = 5, fill = "#1b9e77", color = "black") + 
  geom_x_mean_label(color = "#d95f02", linetype = "dashed", size = 3) 
```
...
ggplot(aes(x = Cooking, y = Electricity, colour = Income, fill=Income)) +
  geom_point() +
  geom_xsidedensity( alpha = .3) + scale_color_brewer(palette = "Dark2") + scale_fill_brewer(palette = "Dark2")
```

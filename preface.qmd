...
In all the charts shown in Figure 2, I used the same dataset, the same variables, and the same Cartesian plane. However, the chart types different.
...
data |>    kbl(col.names = c("Plot", "Statistical Operation", "Visualisation Method")) |> 
  kable_paper("hover", full_width = F)

...
In this context, geoms (short for geometries) are the visual elements used to represent data in a plot. They define the type of chart such as point chart, line chart, bar chart, etc.

...
p6 <- ggplot(worldbankdata2021, aes(x=Income, y=Electricity)) + geom_violin(width = 1, fill="black", trim=TRUE)+ ggtitle("F: geom_violin")
...
Eventhough, I used the same dataset and same cartesian coordinate plane the appearance of the plots are drastically different.

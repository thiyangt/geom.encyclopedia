...
\section{geom\_abline}\label{geom_abline-1}
...
\FunctionTok{library}\NormalTok{(viridis) }\CommentTok{\# Add colors }
\FunctionTok{library}\NormalTok{(rnaturalearthdata) }\CommentTok{\# Spacial Data Analysis}
\FunctionTok{library}\NormalTok{(sf) }\CommentTok{\# Spacial Data Analysis}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  ...
  \AttributeTok{x\_end =} \FunctionTok{c}\NormalTok{(}\FloatTok{2.5}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{, }\FloatTok{6.6}\NormalTok{),}
  \AttributeTok{y\_end =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\FloatTok{2.1}\NormalTok{, }\FloatTok{2.8}\NormalTok{, }\FloatTok{2.7}\NormalTok{))}

...
this context, geoms (short for geometries) are the visual elements used
to represent data in a plot. They define the type of chart such as point
chart, line chart, bar chart, etc.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{preface_files/figure-pdf/unnamed-chunk-4-1.pdf}}
...
In all the charts shown in Figure 2, I used the same dataset, the same
variables, and the same Cartesian plane. However, the chart types
different.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{preface_files/figure-pdf/unnamed-chunk-6-1.pdf}}

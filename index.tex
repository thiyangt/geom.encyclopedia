...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{preface_files/figure-pdf/cartesian-1.pdf}}

}

\caption{Cartesian coordinate plane showing Income (x-axis) and
Electricity (y-axis).}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{preface_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
In all the charts shown in Figure 2 a-h, I used the same dataset, the
same variables, and the same Cartesian plane. However, the chart types
different.
...
\item
  The statistics that we compute on the data to visualize on the chart.
\end{enumerate}
...
we use a suitable geometry to display the computed values. Table 2
summarizes the statistical operations performed on the data and the
corresponding geometries used to visualize the computed statistics.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{preface_files/figure-pdf/unnamed-chunk-5-1.pdf}}
...
\addcontentsline{toc}{section}{Data set use in geom Encyclopedia}

\markright{Data set use in geom Encyclopedia}
...
\addcontentsline{toc}{section}{\texttt{worldbankdata}: Data Profiling}

\markright{\texttt{worldbankdata}: Data Profiling}
...
\addcontentsline{toc}{section}{\texttt{worldbankdata}: Data Quality
Analysis}

\markright{\texttt{worldbankdata}: Data Quality Analysis}
...
\addcontentsline{toc}{section}{R packages with geom implementation}

\markright{R packages with geom implementation}

...
encyclopedia of geometrics in Data Visualisation. This encyclopedia is a
curated collection of \texttt{geom} available in different R programming
software packages. This book can also be considered as an ``Encyclopedia
of Plots''.
...
\section*{Accompanying R package:
drone}\label{accompanying-r-package-drone}
\addcontentsline{toc}{section}{Accompanying R package: drone}

\markright{Accompanying R package: drone}

\section*{\texorpdfstring{{drone}: {D}ata fo{R} ge{O}m
e{N}cyclopa{E}dia}{drone: Data foR geOm eNcyclopaEdia}}\label{drone-data-for-geom-encyclopaedia}
\addcontentsline{toc}{section}{{drone}: {D}ata fo{R} ge{O}m
e{N}cyclopa{E}dia}

\markright{{drone}: {D}ata fo{R} ge{O}m e{N}cyclopa{E}dia}

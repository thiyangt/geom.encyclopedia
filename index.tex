...
\section*{\texorpdfstring{``Data Visualisation {Geom}etrie{s}
Encyclopedia''}{``Data Visualisation Geometries Encyclopedia''}}\label{data-visualisation-geometries-encyclopedia}
\addcontentsline{toc}{section}{``Data Visualisation {Geom}etrie{s}
Encyclopedia''}

\markright{``Data Visualisation {Geom}etrie{s} Encyclopedia''}
...
This book is a work in progress. The accompanying package for drone is
available at: \url{https://github.com/thiyangt/drone}

\section*{\texorpdfstring{drone: {Data} fo{R} ge{O}m
e{N}cyclopa{E}dia}{drone: Data foR geOm eNcyclopaEdia}}\label{drone-data-for-geom-encyclopaedia}
\addcontentsline{toc}{section}{drone: {Data} fo{R} ge{O}m
e{N}cyclopa{E}dia}

\markright{drone: {Data} fo{R} ge{O}m e{N}cyclopa{E}dia}
...
\section{\texorpdfstring{\textbf{geom\_text}}{geom\_text}}\label{geom_text}
...
\section{\texorpdfstring{\textbf{geom\_text\_repel}}{geom\_text\_repel}}\label{geom_text_repel}

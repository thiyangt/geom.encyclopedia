...
\NormalTok{worldbankdata2021 }\OtherTok{\textless{}{-}}\NormalTok{ worldbankdata }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Year }\SpecialCharTok{==} \DecValTok{2021}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{( Income }\SpecialCharTok{==} \StringTok{"LM"} \SpecialCharTok{|}\NormalTok{ Income }\SpecialCharTok{==}\StringTok{"L"}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{select}\NormalTok{( Country, Income, Electricity)}
...
Eventhough, I used the same dataset and same cartesian coordinate plane
the appearance of the plots are drastically different.
...
Each geom has a set of aesthetics that it understands.
...
\addcontentsline{toc}{section}{Data sets use in geom Encyclopedia}

\markright{Data sets use in geom Encyclopedia}
